<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="QLQHNhanThan.aspx.cs" Inherits="Aits_Hrm.Category.QLQHNhanThan" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">

<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
    <title>Quản lý quan hệ nhân thân</title>
</head>
<body>
    <form id="form1" runat="server">
        <telerik:RadScriptManager ID="RadScriptManager1" runat="server" />
        <telerik:RadAjaxPanel ID="RadAjaxPanel1" runat="server" LoadingPanelID="RadAjaxLoadingPanel1">
            <telerik:RadGrid ID="grvQHNhanThan" Culture="vi-VN" runat="server" AllowPaging="True" 
                AllowSorting="True" AutoGenerateColumns="False" CellSpacing="0"
                GridLines="None" ondeletecommand="grvQHNhanThan_DeleteCommand" 
                onneeddatasource="grvQHNhanThan_NeedDataSource" 
                oninsertcommand="grvQHNhanThan_InsertCommand" onunload="grvQHNhanThan_Unload" 
                onupdatecommand="grvQHNhanThan_UpdateCommand" Width="100%">
                <MasterTableView AutoGenerateColumns="False" ShowHeadersWhenNoRecords="True" DataKeyNames="IDQuanHe"
                    ...
                    <Columns>
                        ...
                        <telerik:GridTemplateColumn DataField="QuanHe1" 
                            FilterControlAltText="Filter column column" HeaderText="Quan hệ nhân thân" UniqueName="column">
                            <EditItemTemplate>
                                <asp:TextBox ID="QuanHe1TextBox" runat="server" Text='<%# Bind("QuanHe1") %>'></asp:TextBox>
                            </EditItemTemplate>
                            <ItemTemplate>
                                <asp:Label ID="QuanHe1Label" runat="server" Text='<%# Eval("QuanHe1") %>'></asp:Label>
                            </ItemTemplate>
