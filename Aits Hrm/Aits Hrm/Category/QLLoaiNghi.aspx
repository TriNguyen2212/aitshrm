<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="QLLoaiNghi.aspx.cs" Inherits="Aits_Hrm.Category.QLLoaiNghi" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">

<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
    <title>Quản lý loại nghỉ</title>
</head>
<body>
    <form id="form1" runat="server">
        <telerik:RadScriptManager ID="RadScriptManager1" runat="server" />
        <telerik:RadAjaxPanel ID="RadAjaxPanel1" runat="server" LoadingPanelID="RadAjaxLoadingPanel1">
            <telerik:RadGrid ID="grvLoaiNghi" Culture="vi-VN" runat="server" AllowPaging="True" 
                AllowSorting="True" AutoGenerateColumns="False" CellSpacing="0"
                GridLines="None" ondeletecommand="grvLoaiNghi_DeleteCommand" 
                onneeddatasource="grvLoaiNghi_NeedDataSource" 
                oninsertcommand="grvLoaiNghi_InsertCommand" onunload="grvLoaiNghi_Unload" 
                onupdatecommand="grvLoaiNghi_UpdateCommand" Width="100%">
                <MasterTableView AutoGenerateColumns="False" ShowHeadersWhenNoRecords="True" DataKeyNames="IDLoaiNghi"
                    ...
                    <Columns>
                        ...
                        <telerik:GridTemplateColumn DataField="LoaiNghi1" 
                            FilterControlAltText="Filter column column" HeaderText="Loại nghỉ" UniqueName="column">
                            <EditItemTemplate>
                                <asp:TextBox ID="LoaiNghi1TextBox" runat="server" Text='<%# Bind("LoaiNghi1") %>'></asp:TextBox>
                            </EditItemTemplate>
                            <ItemTemplate>
                                <asp:Label ID="LoaiNghi1Label" runat="server" Text='<%# Eval("LoaiNghi1") %>'></asp:Label>
                            </ItemTemplate>
