<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="QLTrinhDoDT.aspx.cs" Inherits="Aits_Hrm.Category.QLTrinhDoDT" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">

<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
    <title>Quản lý trình độ đào tạo</title>
</head>
<body>
    <form id="form1" runat="server">
        <telerik:RadScriptManager ID="RadScriptManager1" runat="server" />
        <telerik:RadAjaxPanel ID="RadAjaxPanel1" runat="server" LoadingPanelID="RadAjaxLoadingPanel1">
            <telerik:RadGrid ID="grvTrinhDoDT" Culture="vi-VN" runat="server" AllowPaging="True" 
                AllowSorting="True" AutoGenerateColumns="False" CellSpacing="0"
                GridLines="None" ondeletecommand="grvTrinhDoDT_DeleteCommand" 
                onneeddatasource="grvTrinhDoDT_NeedDataSource" 
                oninsertcommand="grvTrinhDoDT_InsertCommand" onunload="grvTrinhDoDT_Unload" 
                onupdatecommand="grvTrinhDoDT_UpdateCommand" Width="100%">
                <MasterTableView AutoGenerateColumns="False" ShowHeadersWhenNoRecords="True" DataKeyNames="IDTrinhDo"
                    ...
                    <Columns>
                        ...
                        <telerik:GridTemplateColumn DataField="TrinhDoDT1" 
                            FilterControlAltText="Filter column column" HeaderText="Trình độ đào tạo" UniqueName="column">
                            <EditItemTemplate>
                                <asp:TextBox ID="TrinhDoDT1TextBox" runat="server" Text='<%# Bind("TrinhDoDT1") %>'></asp:TextBox>
                            </EditItemTemplate>
                            <ItemTemplate>
                                <asp:Label ID="TrinhDoDT1Label" runat="server" Text='<%# Eval("TrinhDoDT1") %>'></asp:Label>
                            </ItemTemplate>
