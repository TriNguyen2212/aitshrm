<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="QLDonViDT.aspx.cs" Inherits="Aits_Hrm.Category.QLDonViDT" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">

<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
    <title>Quản lý đơn vị đào tạo</title>
</head>
<body>
    <form id="form1" runat="server">
        <telerik:RadScriptManager ID="RadScriptManager1" runat="server" />
        <telerik:RadAjaxPanel ID="RadAjaxPanel1" runat="server" LoadingPanelID="RadAjaxLoadingPanel1">
            <telerik:RadGrid ID="grvDonViDT" Culture="vi-VN" runat="server" AllowPaging="True" 
                AllowSorting="True" AutoGenerateColumns="False" CellSpacing="0"
                GridLines="None" ondeletecommand="grvDonViDT_DeleteCommand" 
                onneeddatasource="grvDonViDT_NeedDataSource" 
                oninsertcommand="grvDonViDT_InsertCommand" onunload="grvDonViDT_Unload" 
                onupdatecommand="grvDonViDT_UpdateCommand" Width="100%">
                <MasterTableView AutoGenerateColumns="False" ShowHeadersWhenNoRecords="True" DataKeyNames="IDNoiCapBang"
                    ...
                    <Columns>
                        ...
                        <telerik:GridTemplateColumn DataField="NoiCapBang1" 
                            FilterControlAltText="Filter column column" HeaderText="Đơn vị đào tạo" UniqueName="column">
                            <EditItemTemplate>
                                <asp:TextBox ID="NoiCapBang1TextBox" runat="server" Text='<%# Bind("NoiCapBang1") %>'></asp:TextBox>
                            </EditItemTemplate>
                            <ItemTemplate>
                                <asp:Label ID="NoiCapBang1Label" runat="server" Text='<%# Eval("NoiCapBang1") %>'></asp:Label>
                            </ItemTemplate>
