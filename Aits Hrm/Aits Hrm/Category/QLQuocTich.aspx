<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="QLQuocTich.aspx.cs" Inherits="Aits_Hrm.Category.QLQuocTich" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">

<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
    <title>Quản lý danh mục quốc tịch</title>
</head>
<body>
    <form id="form1" runat="server">
        <telerik:RadScriptManager ID="RadScriptManager1" runat="server" />
        <telerik:RadAjaxPanel ID="RadAjaxPanel3" runat="server" LoadingPanelID="RadAjaxLoadingPanel1">
            <telerik:RadGrid ID="grvQuocTich" Culture="vi-VN" runat="server" AllowPaging="True" 
                AllowSorting="True" AutoGenerateColumns="False" CellSpacing="0"
                GridLines="None" ondeletecommand="grvQuocTich_DeleteCommand" 
                onneeddatasource="grvQuocTich_NeedDataSource" 
                oninsertcommand="grvQuocTich_InsertCommand" onunload="grvQuocTich_Unload" 
                onupdatecommand="grvQuocTich_UpdateCommand" Width="100%">
                <MasterTableView AutoGenerateColumns="False" ShowHeadersWhenNoRecords="True" DataKeyNames="IDQuocTich"
                    ...
                    <Columns>
                        ...
                        <telerik:GridTemplateColumn DataField="QuocTich1" 
                            FilterControlAltText="Filter column column" HeaderText="Quốc tịch" UniqueName="column">
                            <EditItemTemplate>
                                <asp:TextBox ID="QuocTich1TextBox" runat="server" Text='<%# Bind("QuocTich1") %>'></asp:TextBox>
                            </EditItemTemplate>
                            <ItemTemplate>
                                <asp:Label ID="QuocTich1Label" runat="server" Text='<%# Eval("QuocTich1") %>'></asp:Label>
                            </ItemTemplate>
