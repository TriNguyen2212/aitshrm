<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="QLDanToc.aspx.cs" Inherits="Aits_Hrm.Category.QLDanToc" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">

<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
    <title>Quản lý danh mục dân tộc</title>
</head>
<body>
    <form id="form1" runat="server">
        <telerik:RadScriptManager ID="RadScriptManager1" runat="server" />
        <telerik:RadAjaxPanel ID="RadAjaxPanel1" runat="server" LoadingPanelID="RadAjaxLoadingPanel1">
            <telerik:RadGrid ID="grvDanTocs" Culture="vi-VN" runat="server" AllowPaging="True" 
                AllowSorting="True" AutoGenerateColumns="False" CellSpacing="0"
                GridLines="None" ondeletecommand="grvDanTocs_DeleteCommand" 
                onneeddatasource="grvDanTocs_NeedDataSource" 
                oninsertcommand="grvDanTocs_InsertCommand" onunload="grvDanTocs_Unload" 
                onupdatecommand="grvDanTocs_UpdateCommand" Width="100%">
                <MasterTableView AutoGenerateColumns="False" ShowHeadersWhenNoRecords="True" DataKeyNames="IDDanToc"
                    ...
                    <Columns>
                        ...
                        <telerik:GridTemplateColumn DataField="DanToc1"
                            FilterControlAltText="Filter DanToc1 column" HeaderText="Dân tộc" UniqueName="DanToc1">
                            <EditItemTemplate>
                                <asp:TextBox ID="DanToc1TextBox" runat="server" Text='<%# Bind("DanToc1") %>'></asp:TextBox>
                            </EditItemTemplate>
                            <ItemTemplate>
                                <asp:Label ID="DanToc1Label" runat="server" Text='<%# Eval("DanToc1") %>'></asp:Label>
                            </ItemTemplate>
