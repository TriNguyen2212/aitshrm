<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="QLTTHonNhan.aspx.cs" Inherits="Aits_Hrm.Category.QLTTHonNhan" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">

<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
    <title>Quản lý danh mục tình trạng hôn nhân</title>
</head>
<body>
    <form id="form1" runat="server">
        <telerik:RadScriptManager ID="RadScriptManager1" runat="server" />
        <telerik:RadAjaxPanel ID="RadAjaxPanel1" runat="server" LoadingPanelID="RadAjaxLoadingPanel1">
            <telerik:RadGrid ID="grvTTHonNhan" Culture="vi-VN" runat="server" AllowPaging="True" 
                AllowSorting="True" AutoGenerateColumns="False" CellSpacing="0"
                GridLines="None" ondeletecommand="grvTTHonNhan_DeleteCommand" 
                onneeddatasource="grvTTHonNhan_NeedDataSource" 
                oninsertcommand="grvTTHonNhan_InsertCommand" onunload="grvTTHonNhan_Unload" 
                onupdatecommand="grvTTHonNhan_UpdateCommand" Width="100%">
                <MasterTableView AutoGenerateColumns="False" ShowHeadersWhenNoRecords="True" DataKeyNames="IDTinhTrangHonNhan"
                    ...
                    <Columns>
                        ...
                        <telerik:GridTemplateColumn DataField="TinhTrangHonNhan1" 
                            FilterControlAltText="Filter column column" HeaderText="Tình trạng hôn nhân" UniqueName="column">
                            <EditItemTemplate>
                                <asp:TextBox ID="TinhTrangHonNhan1TextBox" runat="server" Text='<%# Bind("TinhTrangHonNhan1") %>'></asp:TextBox>
                            </EditItemTemplate>
                            <ItemTemplate>
                                <asp:Label ID="TinhTrangHonNhan1Label" runat="server" Text='<%# Eval("TinhTrangHonNhan1") %>'></asp:Label>
                            </ItemTemplate>
