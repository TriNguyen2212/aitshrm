<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="QLLoaiBangDT.aspx.cs" Inherits="Aits_Hrm.Category.QLLoaiBangDT" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">

<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
    <title>Quản lý loại bằng đào tạo</title>
</head>
<body>
    <form id="form1" runat="server">
        <telerik:RadScriptManager ID="RadScriptManager1" runat="server" />
        <telerik:RadAjaxPanel ID="RadAjaxPanel1" runat="server" LoadingPanelID="RadAjaxLoadingPanel1">
            <telerik:RadGrid ID="grvLoaiBangDT" Culture="vi-VN" runat="server" AllowPaging="True" 
                AllowSorting="True" AutoGenerateColumns="False" CellSpacing="0"
                GridLines="None" ondeletecommand="grvLoaiBangDT_DeleteCommand" 
                onneeddatasource="grvLoaiBangDT_NeedDataSource" 
                oninsertcommand="grvLoaiBangDT_InsertCommand" onunload="grvLoaiBangDT_Unload" 
                onupdatecommand="grvLoaiBangDT_UpdateCommand" Width="100%">
                <MasterTableView AutoGenerateColumns="False" ShowHeadersWhenNoRecords="True" DataKeyNames="IDLoaiBangDT"
                    ...
                    <Columns>
                        ...
                        <telerik:GridTemplateColumn DataField="LoaiBangDT1" 
                            FilterControlAltText="Filter column column" HeaderText="Loại bằng đào tạo" UniqueName="column">
                            <EditItemTemplate>
                                <asp:TextBox ID="LoaiBangDT1TextBox" runat="server" Text='<%# Bind("LoaiBangDT1") %>'></asp:TextBox>
                            </EditItemTemplate>
                            <ItemTemplate>
                                <asp:Label ID="LoaiBangDT1Label" runat="server" Text='<%# Eval("LoaiBangDT1") %>'></asp:Label>
                            </ItemTemplate>
