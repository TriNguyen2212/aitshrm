<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="SuaTaiKhoan.aspx.cs" Inherits="Aits_Hrm.QuanTri.SuaTaiKhoan" %>
        ...
        <fieldset>
            ...
            <table width="100%">
                <tr>
                    ...
                    <td>
                        <telerik:RadTextBox ID="txtTenDangNhap" runat="server" Width="300px" >
                        </telerik:RadTextBox>
                    </td>
                </tr>
                <tr>
                ...
                <tr>
                    ...
                    <td>
                        <asp:CheckBox ID="chbCanLogin" runat="server" />
                    </td>
                </tr>
            </table>            
        </fieldset>
