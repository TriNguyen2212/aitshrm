<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="QLNghi.aspx.cs" Inherits="Aits_Hrm.Salary.QLNghi" %>
...
<body>
    <form id="form1" runat="server">
        ...
        <telerik:RadToolBar ID="RadToolBar1" Runat="server" EnableRoundedCorners="true" 
            ...
            <Items>
                <telerik:RadToolBarButton runat="server" Value="Save" Text="Gửi đơn"></telerik:RadToolBarButton>
        ...
        <fieldset>
            <legend style="font-weight:bold;">Đơn xin nghỉ</legend>
            <table width="100%">
                <tr>
                ...
                <tr>
                    ...
                    <td>
                        <telerik:RadDatePicker ID="txtTuNgay" Width="80%" AutoPostBack="True"
                            Calendar-CultureInfo="vi-VN" Calendar-DayNameFormat="Short" runat="server" 
                            Culture="vi-VN" ShowPopupOnFocus="True" onselecteddatechanged="txtTuNgay_SelectedDateChanged">
                ...
                <MasterTableView ShowHeadersWhenNoRecords="True" DataKeyNames="IDNghiPhep">
                    ...
                    <Columns>
                        ...
                        <telerik:GridBoundColumn DataField="TuNgay" DataFormatString="{0:dd/MM/yyyy}" 
                            ...
                            HeaderStyle-Width="70px" UniqueName="column3">
                        ...
                        <telerik:GridBoundColumn DataField="DenNgay" DataFormatString="{0:dd/MM/yyyy}" 
                            ...
                            HeaderStyle-Width="70px" UniqueName="column4">
                        </telerik:GridBoundColumn>
                        <telerik:GridBoundColumn DataField="SoNgayDaNghi" HeaderStyle-Width="60px"
                        ...
                        <telerik:GridTemplateColumn DataField="DuocNghi" HeaderStyle-Width="60px"
