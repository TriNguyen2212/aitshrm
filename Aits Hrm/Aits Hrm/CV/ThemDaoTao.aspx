<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ThemDaoTao.aspx.cs" Inherits="Aits_Hrm.CV.ThemDaoTao" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">

<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
    <title>Thêm thông tin bằng cấp của nhân viên</title>
    <style type="text/css">
        .invalid{color:Red;}
...
<body>
    <form id="form1" runat="server">
        ...
        <fieldset>
            <legend style="font-weight:bold;">Thông tin bằng cấp</legend>
            <table width="100%">
                <tr>
                    <td valign="top" rowspan="7">
                        <telerik:RadBinaryImage ID="AnhScan" runat="server" AlternateText="Ảnh scan bằng cấp" 
                            ResizeMode="Fill" Width="160px" Height="160px" ImageUrl="../Images/no_photo.jpg" ImageAlign="Middle" />
                        <span class="invalid"></span>
                    </td>
                </tr>
                <tr>
                    <td style="width:15%;"><label for="cboTrinhDo">Trình độ</label></td>
                    <td style="width:30%;">
                        <telerik:RadComboBox ID="cboTrinhDo" Width="80%" runat="server" />
                    </td>
                    <td style="width:15%;"><label for="cboLoaiHinh">Loại hình đào tạo</label></td>
                    <td  style="width:30%;" align="right">
                        <telerik:RadComboBox ID="cboLoaiHinh" Width="100%" runat="server" />
                    </td>
                </tr>
                <tr>
                    <td><label for="cboNoiDT">Nơi cấp bằng</label></td>
                    <td colspan="3">
            ...
            <telerik:RadGrid ID="grvDaoTao" Culture="vi-VN" runat="server" AllowPaging="True" 
                AllowSorting="True" AutoGenerateColumns="False" CellSpacing="0" 
                GridLines="None" onitemcommand="grvDaoTao_ItemCommand" 
                ondeletecommand="grvDaoTao_DeleteCommand" 
                onneeddatasource="grvDaoTao_NeedDataSource">
                ...
                <MasterTableView ShowHeadersWhenNoRecords="True" DataKeyNames="IDDaoTao">
                    ...
                    <Columns>
                        ...
                        <telerik:GridBoundColumn DataField="TuNgay" DataFormatString="{0:dd/MM/yyyy}" 
                            ...
                            UniqueName="column3" HeaderStyle-Width="60px">
                        </telerik:GridBoundColumn>
                        <telerik:GridBoundColumn DataField="DenNgay" DataFormatString="{0:dd/MM/yyyy}" 
                            ...
                            UniqueName="column4" HeaderStyle-Width="60px">
                        </telerik:GridBoundColumn>
                        <telerik:GridBoundColumn DataField="ChuyenNganh" HeaderStyle-Width="100px"
                        ...
                        <telerik:GridBoundColumn DataField="LoaiBang" 
                            ...
                            HeaderStyle-Width="100px" UniqueName="column6">
                        </telerik:GridBoundColumn>                        
